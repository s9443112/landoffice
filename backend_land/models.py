...
class MarkingDepartment(models.Model):
    ...
    sheet7 = models.CharField('面積',  max_length=50, default=None, null=True, blank=True)
    sheet8 = models.CharField('使用分區',  max_length=50, default=None, null=True, blank=True)
    sheet9 = models.CharField('使用地類別',  max_length=50, default=None, null=True, blank=True)
    sheet10 = models.CharField('公告現值年月',  max_length=50, default=None, null=True, blank=True)

    sheet11 = models.CharField('公告土地現值',  max_length=50, default=None, null=True, blank=True)
    sheet12 = models.CharField('公告地價年月',  max_length=50, default=None, null=True, blank=True)
    sheet13 = models.CharField('公告地價',  max_length=50, default=None, null=True, blank=True)
    sheet14 = models.CharField('地上建物建號',  max_length=50, default=None, null=True, blank=True)
    sheet15 = models.CharField('其他登記事項', max_length=50, default=None, null=True, blank=True)
    sheet16 = models.CharField('地價備註事項', max_length=50, default=None, null=True, blank=True)
...
class OwnershipDepartment(models.Model):
    ...
    sheet12 = models.CharField('相關他項登記次序',  max_length=50, default=None, null=True, blank=True)
    sheet13 = models.CharField('權利範圍',  max_length=50, default=None, null=True, blank=True)
    sheet14 = models.CharField('權狀字號',  max_length=50, default=None, null=True, blank=True)
    sheet15 = models.CharField('當期申報地價年月',  max_length=50, default=None, null=True, blank=True)
    sheet16 = models.CharField('當期申報地價',  max_length=50, default=None, null=True, blank=True)
    
    sheet17 = models.CharField('其他登記事項',  max_length=50, default=None, null=True, blank=True)
    sheet18 = models.CharField('地價備註事項',  max_length=50, default=None, null=True, blank=True)
...
class OwnershipDepartmentHistory(models.Model):
    class Meta:
        verbose_name = '土地所有權部-歷次取得權利範圍'
        verbose_name_plural = '土地所有權部-歷次取得權利範圍'
    ownershipdepartment = models.ForeignKey(
        OwnershipDepartment, on_delete=models.CASCADE)

    sheet1 = models.CharField('年月',  max_length=50, default=None, null=True, blank=True)
    sheet2 = models.CharField('地價',  max_length=50, default=None, null=True, blank=True)
    sheet3 = models.CharField('歷次取得權利範圍',  max_length=50, default=None, null=True, blank=True)
    create_time = DateTimeWithoutTZField('建立日期', default=datetime.now)
    update_time = DateTimeWithoutTZField('更新日期', default=datetime.now)
...
class OtherShipDepartment(models.Model):
    class Meta:
        verbose_name = '土地他項權利部'
        verbose_name_plural = '土地他項權利部'
    markingdepartment = models.ForeignKey(
        MarkingDepartment, on_delete=models.CASCADE)
    ...
    sheet16 = models.CharField('擔保債權種類及範圍',  max_length=50, default=None, null=True, blank=True)
    sheet17 = models.CharField('擔保債權確定期日',  max_length=50, default=None, null=True, blank=True)
    ...
    sheet22 = models.CharField('其他擔保範圍約定',  max_length=50, default=None, null=True, blank=True)
    
    sheet23 = models.CharField('權利標的',  max_length=50, default=None, null=True, blank=True)
    sheet24 = models.CharField('標的登記次序',  max_length=50, default=None, null=True, blank=True)
    sheet25 = models.CharField('設定權利範圍',  max_length=50, default=None, null=True, blank=True)
    sheet26 = models.CharField('證明書字號',  max_length=50, default=None, null=True, blank=True)
    sheet27 = models.CharField('共同擔保地號',  max_length=50, default=None, null=True, blank=True)
    sheet28 = models.CharField('共同擔保建號',  max_length=50, default=None, null=True, blank=True)
    sheet29 = models.CharField('其他登記事項',  max_length=50, default=None, null=True, blank=True)
